...
public class StuffFactory {
	...
	public movemydecide newZombie(int depth, Creature player){
	...
	public movemydecide newGoblin(int depth, Creature player){
	...
	public void creatureeffect(final Item item) {
