...
public class FieldOfView implements visiblentile {
	private World world;
	private int depth;
	...
	public void loop2(int wx, int wy, int wz, int r) {
		for (int x = -r; x < r; x++){
			for (int y = -r; y < r; y++){
				if (x*x + y*y > r*r)
					continue;
				...
				loopinside1(wx, wy, wz, x, y);
			}
		}
	}

	public void loopinside1(int wx, int wy, int wz, int x, int y) {
