...
public class Creature extends club1 implements movemydecide {
	private World world;
	...
	public Creature(World world, char glyph, Color color, String name, int maxHp, int attack, int defense){
		creatureinfo(world, glyph, color, name, maxHp, attack, defense);
	}
	public void creatureinfo(World world, char glyph, Color color, String name, int maxHp, int attack, int defense) {
		this.world = world;
		this.glyph = glyph;
		this.color = color;
		this.maxHp = maxHp;
	...
	private void commonAttack(Creature other, int attack, String action, Object ... params) {
		...
		extractedfor(other, action, amount, params2, params);
		
		if (other.hp < 1)
			gainXp(other);
	}
	public void extractedfor(Creature other, String action, int amount, Object[] params2, Object... params) {
