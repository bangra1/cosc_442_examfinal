...
public class PlayScreen implements Screen {
	...
	public void nestedfor(StuffFactory factory, int z) {
		for (int i = 0; i < 10; i++){
			factory.newBat(z);
		}
	...
	public void for2(StuffFactory factory, int z) {
		for (int i = 0; i < z + 1; i++){
	...
	public void forvalue1(StuffFactory factory, int z) {
	...
	private void displayMessages(AsciiPanel terminal, List<String> messages) {
		...
		loopiffor(terminal, messages, top);
	}

	public void loopiffor(AsciiPanel terminal, List<String> messages, int top) {
	...
	private void displayTiles(AsciiPanel terminal, int left, int top) {
		...
		for (int x = 0; x < screenWidth; x++){
			nested(terminal, left, top, x);
		}
	}

	public void nested(AsciiPanel terminal, int left, int top, int x) {
